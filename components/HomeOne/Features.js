            ...
            <div className="row">
                <div className="col-lg-4 col-sm-6">
                    <div className="single-features">
                        ...
                        <p>nexaya fuels the growth of businesses and startups through international knowledge and local insights to provide hands-on support, emphasizing Digital Transformation, Cyber Security, and Technology Strategy for robust growth.</p>
